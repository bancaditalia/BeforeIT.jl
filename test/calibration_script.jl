...
parameters_mat = matread(joinpath(dir,
                                  "matlab_code/italy_calibration/parameters/2010Q1.mat"))
initial_conditions_mat = matread(joinpath(dir,
                                          "matlab_code/italy_calibration/initial_conditions/2010Q1.mat"))
...
parameters, initial_conditions = Bit.get_params_and_initial_conditions((calibration = calibration_data,
                                                                        figaro = figaro,
                                                                        data = data,
                                                                        ea = ea,
