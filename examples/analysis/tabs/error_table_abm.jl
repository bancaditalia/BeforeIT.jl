            ...
            forecast[i, j, :] = hcat(log.(mean(model["real_gdp_quarterly"][repeat(model["quarters_num"] .==
                                     ...
                                     log.(1 .+
                                          mean(model["gdp_deflator_growth_quarterly"][repeat(model["quarters_num"] .==
                                                                                             ...
                                                                                             1,
                                                                                             number_of_seeds)])),
                                     log.(mean(model["real_household_consumption_quarterly"][repeat(model["quarters_num"] .==
                                                                                                    forecast_quarter_num,
                                                                                                    1,
                                                                                                    number_of_seeds)])),
                                     log.(mean(model["real_fixed_capitalformation_quarterly"][repeat(model["quarters_num"] .==
                                                                                                     forecast_quarter_num,
                                                                                                     1,
                                                                                                     number_of_seeds)])),
                                     (1 .+
