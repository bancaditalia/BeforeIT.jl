...
for date in DateTime(2010, 03, 31):Dates.Month(3):DateTime(2019, 12, 31)
    params, init_conds = Bit.get_params_and_initial_conditions(cal, date; scale = 0.0005)
    ...
    save("data/italy/abm_predictions/$(year(date))Q$(quarterofyear(date)).jld2", "model_dict", prediction_dict)
end
